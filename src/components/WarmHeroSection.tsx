    ...
    <section className="relative overflow-hidden h-[110vh] flex items-center justify-center bg-[hsl(var(--cream))]" id="home">
      ...
      <div className="container mx-auto px-4 z-10 relative text-center pt-28 md:pt-20 -mt-16">
        ...
        >
          ...
          <motion.p
            className="text-sm text-white font-bold mt-4 font-barlow"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="absolute -bottom-8 left-0 right-0 h-32 z-[2] bg-gradient-to-t from-[hsl(var(--cream))] via-[hsl(var(--cream))]/80 to-transparent" />
