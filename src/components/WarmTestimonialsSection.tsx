...
const WarmTestimonialsSection = () => {
  return <section className="section-padding relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => <motion.div key={index} className="bg-white/80 backdrop-blur-sm border border-yellow-200/60 rounded-xl p-8 flex flex-col floating-card relative shadow-md" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
