...
const faqs = [{
  ...
  answer: "At present, we accept Medicare for our mental health services in Havertown. We understand the importance of accessible care and are actively working to expand our accepted insurance plans in the near future. Our staff can help verify your benefits and discuss financial options to make quality mental health care affordable for all residents in Havertown and nearby communities like Drexel Hill and Broomall."
}, {
