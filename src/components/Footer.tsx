      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <Sun className="h-6 w-6 text-sunrise-400" />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/appointment" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Book Appointment
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@sunrisehcsllc.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div className="space-y-4">
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 text-sm rounded-md border border-border bg-background focus:outline-none focus:ring-2 focus:ring-sunrise-400 focus:ring-opacity-50"
                required
              />
              <button
                type="submit"
                className="w-full btn-sunrise text-sm"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              &copy; {currentYear} Sunrise Human Care Services. All rights reserved.
            </p>
