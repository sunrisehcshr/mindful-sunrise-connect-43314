...
const ConditionsSection: React.FC = () => {
  ...
  return <section className="py-16 bg-gradient-to-b from-secondary to-amber-50/50" id="conditions-we-treat" aria-labelledby="conditions-heading">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <TooltipProvider>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-12">
            {conditions.map((condition, index) => <div key={index} className="flex flex-col">
                <Tooltip>
              ...
              duration: 0.3
                    ...
                    <Button variant="ghost" size="sm" onClick={() => setExpandedCondition(null)} className="mt-2 text-primary hover:text-primary-foreground hover:bg-primary/90">
                      Close
                    </Button>
                  </motion.div>}
              </div>)}
