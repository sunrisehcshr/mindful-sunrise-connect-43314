        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col">
              <span className="leading-tight font-extrabold text-base">Sunrise</span>
                          ...
                          <ScrollArea className="h-full w-full max-h-[65vh]">
                            <ul className="grid grid-cols-2 gap-4">
                              {link.children.map((child, childIndex) => <li key={childIndex} className="w-full">
                                  <Link to={child.path} className={cn("block select-none rounded-md p-4 leading-none no-underline outline-none transition-colors hover:bg-orange-500/10 hover:text-orange-600", isActive(child.path) ? "bg-orange-500/10 text-orange-600" : "text-muted-foreground")}>
            ...
            <nav className="flex flex-col space-y-2">
              ...
              if (link.type === "dropdown") {
                return <div key={index} className="space-y-2">
                      ...
                      {mobileServicesOpen && <div className="pl-4 space-y-2 border-l border-orange-200 ml-2">
