      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          ease: "easeOut"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/30 to-transparent z-20 bg-sunrise-500">
              <p className="text-white text-lg font-medium">Creating a safe space for healing</p>
              <p className="text-base font-medium text-slate-50">Personalized therapy and psychiatry services in Havertown, PA for your unique needs.</p>
            </div>
          </motion.div>
        </div>
      </div>
