...
const AppointmentSection: React.FC = () => {
  return <section id="appointment" className="py-20 bg-white/50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="h-64 md:h-80 rounded-xl overflow-hidden border border-sunrise-100/50 shadow-sm">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3059.025196175262!2d-75.35433992420519!3d39.97271998652599!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c6c1c6a4c1b55b%3A0xa5a74da50eaac1d!2s2050%20West%20Chester%20Pike%2C%20Havertown%2C%20PA%2019083!5e0!3m2!1sen!2sus!4v1682187759696!5m2!1sen!2sus" width="100%" height="100%" style={{
                border: 0
