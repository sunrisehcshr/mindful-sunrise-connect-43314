      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 grid grid-cols-2 gap-4">
            <img className="rounded-2xl h-40 object-cover w-full md:h-64 shadow-md" src="https://https://images2.imgbox.com/96/8b/OU4kwnl0_o.jpg&auto=format&fit=crop&w=500&q=80" alt="Our clinic building" />
