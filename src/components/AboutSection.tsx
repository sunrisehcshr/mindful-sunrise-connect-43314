...
const AboutSection = () => {
  return <section id="about" className="py-24 bg-transparent">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{
          ...
          <div className="aspect-video rounded-xl overflow-hidden shadow-lg">
            <img src="/images/therapy-for-older-adults.webp" alt="Therapy for older adults at Sunrise Human Care Services" className="w-full h-full object-cover" />
          </div>
