        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src="/images/logo.png" alt="Sunrise Human Care Services Logo" className="h-12 w-14 object-contain transition-transform duration-300 group-hover:-translate-y-1" />
