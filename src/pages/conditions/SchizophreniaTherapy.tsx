...
const SchizophreniaTherapy = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Schizophrenia & Psychotic Disorders Treatment Havertown | Sunrise Human Care" 
        description="Comprehensive schizophrenia treatment in Havertown, PA. Our integrated approach includes therapy, medication management, family support, and skills training for improved daily functioning and quality of life. Call (814) 620-2162." 
        canonicalUrl="https://sunrisehumancare.com/schizophrenia-treatment-havertown-pa"
        keywords="schizophrenia treatment Havertown, psychotic disorders therapy PA, CBT for psychosis Delaware County, family therapy schizophrenia, psychoeducation for families, early psychosis intervention, hallucination treatment"
        serviceSchema={{
      ...
      >
        ...
        <section className="py-16 bg-orange-50">
          <div className="container mx-auto px-4 md:px-6 max-w-3xl">
            ...
            <p className="mb-6">In addition to our treatment services, we encourage clients and families to explore these helpful resources:</p>
            
            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                <span className="text-orange-500 mr-2">•</span>
                <div>
                  <strong className="block">National Alliance on Mental Illness (NAMI)</strong>
                  <span>Offers support groups, education programs, and resources for individuals and families. NAMI Delaware County: <a href="https://namipadelco.org" className="text-orange-600 hover:underline" target="_blank" rel="noopener noreferrer">www.namipadelco.org</a></span>
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-orange-500 mr-2">•</span>
                <div>
                  <strong className="block">Schizophrenia & Psychosis Action Alliance</strong>
                  <span>Provides information, support, and advocacy: <a href="https://sczaction.org" className="text-orange-600 hover:underline" target="_blank" rel="noopener noreferrer">www.sczaction.org</a></span>
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-orange-500 mr-2">•</span>
                <div>
                  <strong className="block">SMI Adviser</strong>
                  <span>Evidence-based information and resources: <a href="https://smiadviser.org" className="text-orange-600 hover:underline" target="_blank" rel="noopener noreferrer">www.smiadviser.org</a></span>
                </div>
              </li>
            </ul>
            
            <div className="text-center">
              <p className="mb-6">If you or a loved one is experiencing a mental health crisis:</p>
              <p className="font-bold">988 Suicide & Crisis Lifeline: Call or text 988</p>
              <p className="font-bold">Crisis Text Line: Text HOME to 741741</p>
              <p className="font-bold">Delaware County Crisis Connections Team: 1-855-889-7827</p>
              <p className="mt-4">For non-emergency information about our schizophrenia treatment program in Havertown, call us at (814) 620-2162.</p>
            </div>
          </div>
        </section>
      </ServicePageLayout>
