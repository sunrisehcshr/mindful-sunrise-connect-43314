...
const SleepDisordersTherapy = () => {
  return (
    <ServicePageLayout
      ...
      pageTitle="Sleep Disorders Treatment | Sunrise Human Care Services | Havertown, PA"
      ...
      canonicalUrl="https://sunrisehumancare.com/sleep-disorders-treatment-havertown-pa"
      benefits={[
      ...
      relatedServices={[
        ...
        { title: "Stress Management", url: "/stress-management-havertown-pa" }
      ]}
    >
