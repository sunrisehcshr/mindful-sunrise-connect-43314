...
const SubstanceUseTherapy = () => {
  ...
  const relatedServices = [
    ...
    { title: "Trauma & PTSD Therapy in Havertown", url: "/ptsd-therapy-havertown-pa" }
  ];
  ...
  return (
    <ServicePageLayout
      ...
      pageTitle="Substance Use Treatment in Havertown, PA | Addiction Recovery | Sunrise Human Care Services"
      metaDescription="Comprehensive substance use and addiction treatment in Havertown, PA serving Delaware County. Evidence-based approaches for alcohol and drug recovery with personalized care. Serving Havertown, Drexel Hill, and Broomall."
    ...
    >
      ...
      <ServiceContentSection
        title="Our Substance Use Treatment Approach in Havertown"
        hasBgPattern={true}
      >
          ...
          >
            ...
            <div className="mt-7 pt-5 border-t border-orange-100">
              ...
              <ul className="space-y-3">
                {[
                  { name: "Understanding Dual Diagnosis", url: "/blog/dual-diagnosis-treatment" },
                  { name: "Depression and Substance Use", url: "/depression-therapy-havertown-pa" },
                  { name: "Family Support in Recovery", url: "/family-therapy-havertown-pa" }
                ].map((resource, index) => (
                  <li key={index}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="pl-6 pt-6">
              <p className="italic text-amber-900">The substance use treatment I received at Sunrise Human Care in Havertown was life-changing. Their approach addressed both my drinking problem and underlying anxiety. The therapists were compassionate, never judgmental, and truly understood addiction. I'm now 14 months sober and have tools to maintain my recovery for the long-term.</p>
              <p className="mt-4 font-medium text-amber-800">- Recovery client, Havertown</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="pl-6 pt-6">
              <p className="italic text-amber-900">After struggling with prescription medication abuse following a surgery, I needed help but was afraid of judgment. The addiction treatment team at Sunrise in Havertown provided exactly what I needed - professional, compassionate care that addressed my substance use without stigma. Their dual diagnosis approach helped with both the addiction and my chronic pain management.</p>
              <p className="mt-4 font-medium text-amber-800">- Recovery client, Drexel Hill</p>
            </div>
          </motion.div>
        </div>
      </ServiceContentSection>
