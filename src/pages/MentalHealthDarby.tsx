        ...
        <main className="flex-grow">
          ...
          {/* Premium Video Hero Section */}
           <section className="relative min-h-[90vh] flex items-center md:items-end justify-center overflow-hidden md:pb-24">
            ...
            {/* Gradient overlay - subtle darkening behind text area */}
            <div className="absolute inset-0 bg-gradient-to-b from-black/5 via-black/15 via-60% to-black/40" />
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col items-center justify-end text-center">
              ...
              >
                <h1 className="mb-6">
                  <span className="block font-barlow font-semibold text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-[-0.04em] leading-tight [text-shadow:_0_2px_12px_rgba(0,0,0,0.5)]">
                    Step into a brighter tomorrow
                  </span>
                  <span className="block font-instrument-serif italic text-amber-200 text-5xl sm:text-6xl md:text-7xl lg:text-[84px] leading-none mt-2 [text-shadow:_0_2px_16px_rgba(0,0,0,0.4)]">
                    with sunrise
                  </span>
                </h1>
                ...
                >
                  <Link
                    to="/appointment"
                    className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md text-white font-barlow font-semibold text-base md:text-lg px-8 py-4 rounded-full border border-white/30 shadow-lg hover:bg-white/25 hover:scale-105 transition-all duration-300"
                  >
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <h3 className="font-barlow font-semibold text-lg text-stone-800">{item.title}</h3>
                        </div>
                        <p className="font-barlow text-stone-500 text-sm leading-relaxed">{item.desc}</p>
                      </motion.div>
                    ))}
                  </div>
                </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {services.map((service, index) => (
                      ...
                      >
                        <Link 
                          to={service.link}
                          className="group flex items-start gap-5 rounded-2xl p-6 border border-stone-200/80 hover:border-amber-200 hover:shadow-lg transition-all duration-300 bg-white"
                        >
                          <div className="flex-shrink-0 w-10 h-10 rounded-full bg-amber-600 flex items-center justify-center mt-0.5 group-hover:bg-amber-500 transition-colors duration-300">
                            <ArrowRight className="h-4 w-4 text-white rotate-[-45deg]" />
                          </div>
                          <div>
                            <h3 className="font-barlow font-semibold text-lg text-stone-800 mb-1.5 group-hover:text-amber-800 transition-colors">
                              {service.title}
                            </h3>
                            <p className="font-barlow text-stone-500 text-sm leading-relaxed">
                              {service.description}
                            </p>
                          </div>
                        </Link>
          ...
          <section id="conditions" className="py-20 md:py-28 bg-[#f0ece4]">
            <div className="container mx-auto px-4 md:px-6">
              <div className="max-w-5xl mx-auto">
                ...
                >
                  <div className="text-center mb-14">
                    <span className="inline-block font-barlow font-semibold text-xs tracking-[0.2em] uppercase text-amber-600/70 mb-4">Conditions</span>
                    <h2 className="font-barlow font-bold text-3xl md:text-4xl lg:text-5xl text-stone-800 tracking-tight leading-tight">
                      Concerns we
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {conditions.map((condition, index) => (
                      <motion.div
                        ...
                        className="bg-white rounded-2xl p-5 md:p-6 border border-stone-200/80 text-center hover:shadow-md hover:border-amber-200 transition-all duration-300"
                      >
                        <span className="font-barlow font-semibold text-stone-700 text-base">{condition}</span>
                      </motion.div>
                    ))}
                  </div>
                  
                  <p className="font-barlow text-stone-500 mt-8 text-center text-sm">
              ...
              <div className="max-w-5xl mx-auto">
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                    ...
                    <div className="bg-amber-800 rounded-2xl p-8 text-white">
                      <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center justify-center w-10 h-10 rounded-full bg-amber-100/20">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          <li key={i} className="flex items-center gap-3 font-barlow text-amber-100 text-sm">
                  ...
                  <Accordion type="single" collapsible className="space-y-3">
                    {faqs.map((faq, index) => (
                      <AccordionItem 
                        key={index} 
                        value={`faq-${index}`}
                        className="bg-white rounded-2xl border border-stone-200/80 px-6 data-[state=open]:shadow-md data-[state=open]:border-amber-200 transition-all duration-300"
                      >
                        <AccordionTrigger className="text-left font-barlow font-semibold text-stone-800 hover:text-amber-700 hover:no-underline py-5 text-base">
                          {faq.question}
                        </AccordionTrigger>
                        <AccordionContent className="font-barlow text-stone-500 pb-5 text-sm leading-relaxed">
                          {faq.answer}
                        </AccordionContent>
                      </AccordionItem>
                    ))}
          ...
          <section className="relative py-24 md:py-32 overflow-hidden">
            ...
            {/* Warm Overlay */}
            <div className="absolute inset-0 bg-amber-900/55" />
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
              <div className="max-w-3xl mx-auto text-center">
                ...
                >
                  ...
                  <p className="font-barlow text-white/85 text-base md:text-lg mb-10 max-w-xl mx-auto leading-relaxed drop-shadow-md">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link 
                      to="/appointment" 
                      className="inline-flex items-center justify-center gap-2 bg-white text-amber-900 font-barlow font-semibold text-base px-8 py-4 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                    >
                      <Calendar className="h-5 w-5" />
                    ...
                    <a 
                      ...
                      className="inline-flex items-center justify-center gap-2 bg-white/15 backdrop-blur-sm border border-white/30 text-white font-barlow font-semibold text-base px-8 py-4 rounded-full hover:bg-white/25 transition-all duration-300"
                    >
