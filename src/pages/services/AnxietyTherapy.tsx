...
const AnxietyTherapy = () => {
  ...
  const faqs = [{
    ...
    answer: "Many clients experience significant improvement within 8-16 sessions of anxiety-focused treatment. However, the timeline varies based on anxiety severity, type, and individual factors. At our Darby anxiety therapy center, we'll discuss expected timeframes during your initial consultation and adjust the treatment plan based on your progress and needs throughout therapy."
  }, {
    question: "Will I need medication for my anxiety?",
    answer: "Not necessarily. Many people effectively manage anxiety through therapy alone. After a thorough assessment at our Darby mental health clinic, if medication might be beneficial, we can discuss a referral to our psychiatric providers. Our anxiety treatment in Darby supports both medication and non-medication approaches based on your specific needs, preferences, and the severity of your anxiety symptoms."
  }, {
    question: "Will I have to talk about things that make me anxious?",
    answer: "Gradually addressing anxiety triggers is often part of effective treatment at our Darby anxiety therapy practice. However, we move at your pace and use techniques to make this process manageable. Our experienced therapists in Darby provide a safe environment where you can build confidence to face anxiety-provoking situations, but we'll never force you to discuss something you're not ready to explore."
  }, {
    question: "Is my anxiety just something I have to live with?",
    answer: "No. Anxiety disorders are highly treatable, and most people experience significant reduction in symptoms with proper treatment at Sunrise Human Care Services in Darby. While occasional anxiety is part of life, debilitating anxiety is not something you simply have to endure. Our evidence-based anxiety therapy in Darby has helped many clients regain control and live fulfilling lives despite previous struggles with anxiety."
  }];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          delay: 0.2
            ...
            <div className="space-y-5 text-muted-foreground">
              <p className="leading-relaxed">
                At Sunrise Human Care Services in Darby, PA, we provide specialized, evidence-based anxiety treatment for all types of anxiety disorders. Our approach begins with a thorough assessment to understand your specific anxiety symptoms, triggers, and how anxiety is impacting your life.
              </p>
          ...
          delay: 0.4
            ...
            <h3 className="text-xl font-semibold mb-5 text-orange-600 font-playfair">
              Our Anxiety Treatment in Darby Helps With:
            </h3>
