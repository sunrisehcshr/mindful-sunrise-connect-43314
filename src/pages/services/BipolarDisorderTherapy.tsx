        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          delay: 0.2
            ...
            <div className="space-y-5 text-muted-foreground">
              ...
              <p className="leading-relaxed">
                Bipolar disorder is characterized by distinct mood episodes ranging from depressive lows to manic or hypomanic highs. These episodes can significantly impact your relationships, work, and daily functioning. Our evidence-based bipolar disorder therapy in Havertown combines therapeutic approaches, lifestyle recommendations, and collaboration with psychiatric providers for medication management when appropriate.
              </p>
              
              <p className="leading-relaxed">
                Our therapists have specialized training in bipolar disorder treatment and stay current with the latest research and best practices. Our bipolar disorder therapy in Havertown focuses not only on symptom management but also on helping you build a fulfilling life with enhanced stability, improved relationships, and better overall functioning.
              </p>
              
              <p className="leading-relaxed">
                We provide bipolar disorder treatment services to clients throughout Havertown, Drexel Hill, Broomall, and surrounding Delaware County communities. Our integrated approach addresses all aspects of bipolar disorder management, including <Link to="/medication-management-havertown-pa" className="text-orange-600 hover:underline">medication support</Link>, <Link to="/individual-therapy-havertown-pa" className="text-orange-600 hover:underline">individual therapy</Link>, and family education.
              </p>
            </div>
          </motion.div>
