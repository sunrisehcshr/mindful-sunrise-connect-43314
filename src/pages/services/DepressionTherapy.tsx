...
const DepressionTherapy = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Depression Treatment in Darby, PA | Expert Therapy Services | Sunrise Human Care"
        description="Effective depression therapy in Darby, PA. Our experienced therapists provide evidence-based treatment for depression, helping you rediscover joy and purpose. Serving Delaware County. Call (814) 620-2162."
        canonicalUrl="https://sunrisehumancare.com/depression-therapy-darby-pa"
        keywords="depression therapy Darby, depression treatment PA, depression counseling Delaware County, mood disorder treatment Darby, mental health services PA, depression help near me, evidence-based depression treatment, therapist Darby PA"
        serviceSchema={{
          ...
          <div className="relative mb-8">
            ...
            <div className="relative p-6 text-center">
              <p className="text-lg font-medium text-amber-900">
                "Depression is treatable, and recovery is possible. Our Darby therapy team is here to guide you towards renewed hope and well-being."
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <motion.div initial={{
              ...
              <div className="space-y-5 text-muted-foreground">
                <p className="leading-relaxed">
                  At Sunrise Human Care Services in Darby, PA, we understand that depression affects each person differently. Our depression therapy begins with a comprehensive assessment to understand your specific symptoms, history, and the unique factors contributing to your depression.
                </p>
                
                <p className="leading-relaxed">
                  Using evidence-based depression treatment, we'll help you identify and change negative thought patterns, develop healthy coping strategies, and gradually increase meaningful activities that can improve your mood. Our depression therapy in Darby focuses not only on symptom reduction but also on helping you build a more fulfilling life.
                </p>
                
                <p className="leading-relaxed">
                  When appropriate, we collaborate with our psychiatric providers to offer integrated care that may include medication management alongside depression therapy. Throughout treatment, we'll regularly assess your progress and adjust our approach to ensure you're receiving the most effective depression treatment in Darby for your specific needs.
                </p>
            ...
            <motion.div initial={{
              ...
              <h3 className="text-xl font-semibold mb-5 text-orange-600 font-playfair">
                Our Depression Treatment in Darby Helps With:
              </h3>
