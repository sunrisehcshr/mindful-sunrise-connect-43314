...
const MedicationManagement = () => {
  const benefits = [
    "Expert psychiatric medication guidance tailored to your specific needs",
    "Comprehensive monitoring to minimize side effects and maximize benefits",
    "Personalized medication adjustments based on your response and needs",
    "Integrated approach combining medication with therapy for optimal outcomes",
    "Educational resources about your condition and medication options",
    "Ongoing support throughout your medication management journey in Havertown"
  ];
  ...
  const relatedServices = [
    { title: "Psychiatric Evaluations in Havertown", url: "/psychiatric-evaluations-havertown-pa" },
  ...
  return (
    <ServicePageLayout
      ...
      metaDescription="Professional psychiatric medication management in Havertown, PA serving Delaware County. Personalized medication services for depression, anxiety, ADHD, and other mental health conditions with expert psychiatrists. Schedule today."
    ...
    >
      ...
      <ServiceContentSection
        title="Our Medication Management Approach in Havertown"
        hasBgPattern={true}
      >
          ...
          >
            ...
            <div className="mt-7 pt-5 border-t border-orange-100">
              ...
              <ul className="space-y-3">
                {[
                  { name: "Understanding Psychiatric Medications", url: "/blog/understanding-psychiatric-medications" },
                  { name: "Therapy and Medication Combined", url: "/blog/therapy-and-medication" },
                  { name: "ADHD Medication Guide", url: "/adhd-treatment-havertown-pa" }
                ].map((resource, index) => (
                  <li key={index}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="pl-6 pt-6">
              <p className="italic text-amber-900">The medication management I received at Sunrise Human Care in Havertown transformed my experience with anxiety treatment. Their psychiatric team took time to find the right medication at the right dose, with minimal side effects. They explained everything clearly and worked alongside my therapist. For the first time, I feel balanced and in control.</p>
              <p className="mt-4 font-medium text-amber-800">- Medication management client, Havertown</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="pl-6 pt-6">
              <p className="italic text-amber-900">After struggling with ADHD for years, finding the right medication management in Havertown made all the difference. The psychiatric team at Sunrise was incredibly thorough in their evaluation and patient in finding the right treatment. They coordinated with my therapist and even helped me develop strategies beyond medication. The convenience of their Havertown location makes maintaining my treatment plan easy.</p>
              <p className="mt-4 font-medium text-amber-800">- Medication management client, Broomall</p>
            </div>
          </motion.div>
        </div>
      </ServiceContentSection>
      ...
      <ServiceContentSection 
        title="Medication Management Services Throughout Delaware County"
        hasBgPattern={true}
      >
