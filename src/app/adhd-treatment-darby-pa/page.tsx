...
export default function ADHDTreatmentPage() {
  const adhdFAQs = [
    ...
    },
    {
      ...
      answer: "Not necessarily. While stimulant medications (like Adderall or Ritalin) are often the most effective first-line treatment for managing symptoms, non-stimulant medications and behavioral therapies are also highly effective. We provide comprehensive evaluations to find the safest and best approach for your specific needs."
    },
    {
      question: "I was never diagnosed as a child. Can adults have ADHD?",
      answer: "Absolutely. Many adults with ADHD were never diagnosed in childhood, especially those who did not exhibit disruptive hyperactive behaviors. Adult ADHD often presents as chronic disorganization, missed deadlines, relationship issues, and persistent feelings of underachievement."
    },
    {
  ...
  const breadcrumbs = [
    ...
    { name: "ADHD Treatment", url: "/adhd-treatment-darby-pa" }
  ];

  const serviceData = {
    name: "ADHD Testing & Treatment in Darby, PA",
    description: "Comprehensive ADHD assessment and treatment for children and adults. Specialized psychiatric care with no waitlist and Medicaid acceptance.",
