          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }} className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 hover:border-amber-200 transition-all duration-300">
              ...
              <ul className="space-y-4">
                {[
                  "Bereavement due to death of loved ones",
                  "Complicated or prolonged grief",
                  "Traumatic or sudden losses",
                  "Ambiguous loss (missing persons, dementia)",
                  "Loss of health, identity, or career",
                  "Relationship endings or divorce",
                  "Grief related to major life transitions",
                  "Anticipatory grief for terminal illness"
                ].map((item, index) => (
