          ...
          <section className="pt-16 md:pt-24 pb-40 bg-stone-50 relative overflow-hidden">
            <div className="container mx-auto px-4 md:px-8 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {[
                  { title: "Severe Depression", link: "/depression-therapy-darby-pa", icon: Sparkles, desc: "Lift the heavy fog. We evaluate treatment-resistant depression to find the right medication and therapeutic approach for your brain chemistry." },
                  { title: "Anxiety & Panic", link: "/anxiety-therapy-darby-pa", icon: Shield, desc: "Stop the spiraling. Get a precise assessment to differentiate between generalized anxiety, panic disorders, and OCD for targeted relief." },
                  { title: "ADHD & Focus Issues", link: "/adhd-treatment-darby-pa", icon: Lightbulb, desc: "Regain your concentration. We provide thorough evaluations for adult and childhood ADHD to help you harness your focus and productivity." },
