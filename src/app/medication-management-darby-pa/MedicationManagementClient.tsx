    ...
    <div className="flex flex-col min-h-screen bg-stone-950">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
            ...
            >
              <span className="inline-block font-barlow font-bold text-[10px] sm:text-xs tracking-[0.2em] uppercase text-orange-400 mb-6 bg-orange-500/10 px-5 py-2.5 rounded-full border border-orange-500/20 backdrop-blur-md">
                Safe, Effective Psychiatric Care
              </span>
              <h1 className="text-balance font-barlow font-normal text-4xl md:text-6xl lg:text-7xl text-white tracking-tighter leading-[1.1] mb-6 drop-shadow-md">
                Find the Right Balance with <br className="hidden md:block" />
                <span className="font-instrument-serif italic text-orange-400 font-normal drop-shadow-md">Medication Management in Darby, PA</span>
              </h1>
              <p className="text-stone-100 font-barlow text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-10 drop-shadow-md">
                Stop struggling with side effects and treatments that don't work. Get a safe, personalized medication plan from psychiatric specialists who monitor your progress closely.
              </p>
        ...
        <div className="bg-white relative z-10 -mt-10 rounded-t-[3rem] overflow-hidden shadow-[0_-30px_60px_rgba(0,0,0,0.15)]">
          ...
          {/* SECTION 1: Understanding Medication Management (Bento Grid) */}
                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <h2 className="text-3xl md:text-5xl text-balance font-normal text-stone-900 tracking-tighter leading-tight">
                            Medication designed for your biology, <br className="hidden md:block" /><span className="font-instrument-serif italic text-orange-500">not a one-size-fits-all approach.</span>
                        </h2>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="grid grid-cols-1 gap-4 md:grid-cols-3 relative z-10">
                        <Card containerClassName="rounded-3xl bg-emerald-50/40 border-emerald-100/50" className="p-8">
                            ...
                            <p className="text-sm text-stone-600 leading-relaxed font-medium">Work with fully licensed, state-certified psychiatric providers who prioritize your safety and long-term health above all else.</p>
                        </Card>
                        <Card containerClassName="rounded-3xl bg-blue-50/40 border-blue-100/50" className="p-8">
                            ...
                            <h3 className="text-xl font-bold text-stone-900 mb-3 group-hover:text-blue-700 transition-colors">Precise Adjustments</h3>
                            <p className="text-sm text-stone-600 leading-relaxed font-medium">We carefully monitor your progress and make precise, science-backed adjustments to minimize side effects and maximize relief.</p>
                        </Card>
                        <Card containerClassName="rounded-3xl bg-rose-50/40 border-rose-100/50" className="p-8">
                            ...
                            <h3 className="text-xl font-bold text-stone-900 mb-3 group-hover:text-rose-700 transition-colors">Tailored to Your Biology</h3>
                            <p className="text-sm text-stone-600 leading-relaxed font-medium">Your prescription plan is customized to your unique genetics, lifestyle, and overall medical history.</p>
                        </Card>
                    </motion.div>
                </motion.div>
            </div>
          ...
          <section className="pt-16 md:pt-24 pb-40 bg-stone-50 relative overflow-hidden">
            <div className="container mx-auto px-4 md:px-8 relative z-10">
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  <SectionTag>Targeted Medical Relief</SectionTag>
                  <h2 className="text-3xl md:text-5xl text-balance font-normal text-stone-900 tracking-tighter leading-tight">
                    Find the right medication for <br />
                  ...
                  <p className="text-stone-500 font-barlow text-lg leading-relaxed max-w-2xl mx-auto mt-2">
                    You don't have to settle for treatments that leave you feeling numb or exhausted. Our psychiatric specialists in Darby, PA provide careful medication management for a wide range of conditions.
                  </p>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {[
                  { title: "Treatment-Resistant Depression", link: "/depression-therapy-darby-pa", icon: Sparkles, desc: "Find the right antidepressant to lift the heavy fog without the frustrating side effects." },
                  { title: "Severe Anxiety & Panic", link: "/anxiety-therapy-darby-pa", icon: Shield, desc: "Stabilize your nervous system with safe, non-habit-forming medications designed to quiet your racing mind." },
                  { title: "Adult & Child ADHD", link: "/adhd-treatment-darby-pa", icon: Lightbulb, desc: "Regain your focus and productivity. We safely prescribe and monitor stimulant and non-stimulant ADHD treatments." },
                  { title: "Bipolar & Mood Instability", link: "/bipolar-disorder-therapy-darby-pa", icon: Star, desc: "Smooth out the unpredictable highs and lows with a carefully managed mood stabilizer regimen." },
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
                    <div className="lg:col-span-5 flex flex-col justify-center">
                        ...
                        <h2 className="text-3xl md:text-5xl text-balance font-normal text-white tracking-tighter leading-tight mb-6">
                            Discover Psychiatric Care <br className="hidden md:block" />
                            <span className="font-instrument-serif italic text-orange-400">That Prioritizes Your Wellbeing</span>
                        </h2>
                        <p className="text-stone-400 text-lg leading-relaxed mb-8">
                            Stop enduring trial-and-error treatments. Your brain chemistry is unique, which is why we use evidence-based psychiatric protocols to ensure you receive the safest, most effective medical care possible.
                        </p>
                    </div>
              ...
              >
                 ...
                 <div className="relative z-10 flex flex-col items-center">
                   ...
                   <p className="text-white/90 font-barlow text-lg max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow-md">
                     You don't have to navigate confusing side effects alone. Schedule your medication management consultation today and let our Darby, PA specialists help you take control of your treatment.
                   </p>
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12 flex flex-col items-center gap-4">
                  ...
                  <h2 className="text-3xl md:text-5xl text-balance font-normal text-stone-900 tracking-tighter leading-tight">
                    Medication Management <span className="font-instrument-serif italic text-orange-500">FAQs.</span>
                  </h2>
                </div>
          ...
          <section className="pt-24 pb-0 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
              ...
              <AnimatedCardStack items={[
                  ...
                  { title: "Depression Therapy in Darby", description: "Evidence-based treatment for depression and mood disorders.", href: "/depression-therapy-darby-pa", image: "/images/depression-therapy-havertown.webp" }
                ]} />
            </div>
          </section>
