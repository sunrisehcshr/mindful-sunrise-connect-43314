...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "A comprehensive guide to finding the right therapist in Darby, PA. Learn about therapy types, insurance options, and how to choose the best mental health professional.",
