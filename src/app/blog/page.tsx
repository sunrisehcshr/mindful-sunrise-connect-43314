...
import { CalendarIcon, Clock3, ArrowUpRight, BookOpen } from "lucide-react";
...
export default function BlogPage() {
  const blogPosts = [{
    ...
    excerpt: "Discover how to find the perfect therapist in Darby, PA. Learn about therapy types, insurance options, and what to look for in a mental health professional.",
    date: "Oct 28, 2025",
    ...
    excerpt: "Comprehensive guide to anxiety treatment in Delaware County. Learn about therapy approaches, medication options, and local resources.",
    date: "Oct 27, 2025",
    ...
    excerpt: "Understanding depression treatment options in Darby, PA. From evidence-based therapies to medication management.",
    date: "Oct 26, 2025",
    ...
    excerpt: "Learn how family therapy in Darby can help resolve conflicts, improve communication, and strengthen relationships.",
    date: "Oct 25, 2025",
    readTime: "9 min read",
    ...
    excerpt: "Complete guide to ADHD treatment in Darby, PA. Explore therapy options, medication management, and local resources.",
    date: "Oct 24, 2025",
            ...
            <div className="container mx-auto px-4 relative z-10">
              ...
              >
                <div className="mb-6 flex justify-center">
                  <SectionTag className="border-white/20 text-white bg-white/10">Expert Insights</SectionTag>
                </div>
                <h1 className="font-barlow font-bold text-4xl md:text-7xl text-white tracking-tighter leading-none mb-8">
                  Healing Through <br />
                  <span className="font-instrument-serif italic text-orange-500 font-normal">Understanding.</span>
                </h1>
                <p className="text-stone-300 text-lg md:text-xl font-barlow max-w-2xl mx-auto leading-relaxed">
                  Deep dives into mental wellness, clinical strategies, and Darby community resources from our licensed professionals.
                </p>
              </motion.div>
            </div>
              ...
              <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {blogPosts.map((post, idx) => (
                    ...
                    >
                      <Link href={`/blog/${post.id}`} className="block relative aspect-[16/10] overflow-hidden rounded-[2rem] border border-stone-100 shadow-sm mb-6">
                        <img 
                          src={post.image} 
                          alt={post.title}
                      ...
                      <div className="flex items-center gap-4 mb-3 text-[11px] font-bold uppercase tracking-wider text-stone-400">
                        <span className="flex items-center gap-1.5">
                          <CalendarIcon className="w-3 h-3 text-orange-500" /> {post.date}
                        </span>
                        <span className="flex items-center gap-1.5">
                          <Clock3 className="w-3 h-3 text-orange-500" /> {post.readTime}
                        </span>
                      </div>
