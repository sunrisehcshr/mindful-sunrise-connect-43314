            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {[
                  ...
                  { title: "Teen Behavioral Issues", link: "/child-therapy-darby-pa", icon: Sparkles, desc: "Bridge the gap with your teenager. Create a safe space to address acting out, peer pressure, and emotional withdrawal." },
                  ...
                  { title: "Divorce & Separation", link: "/couples-counseling-darby-pa", icon: ArrowRight, desc: "Protect your children through transition. Safely process painful changes and establish healthy co-parenting dynamics." },
              ...
              >
                 ...
                 <div className="relative z-10 flex flex-col items-center">
                   ...
                   <h2 className="text-balance font-barlow font-normal text-4xl md:text-5xl lg:text-6xl text-white tracking-tighter leading-[1.1] mb-6 max-w-3xl drop-shadow-lg">
                     ...
                     <span className="font-instrument-serif italic text-orange-400 font-normal">in your home.</span>
                   </h2>
          ...
          <section className="pt-24 pb-0 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
              ...
              <AnimatedCardStack items={[
                  { title: "Couples Counseling in Darby", description: "Strengthen your bond with relationship counseling.", href: "/couples-counseling-darby-pa", image: "/images/couple-counseling-havertown-pa.webp" },
                  { title: "Child & Adolescent Therapy in Darby", description: "Specialized therapy for children and adolescents.", href: "/child-therapy-darby-pa", image: "/images/family-therapy-havertown-guide.webp" },
